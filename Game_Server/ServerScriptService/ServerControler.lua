...
local TeleportReceiver = require(game.ServerScriptService.TeleportReceiver)
...
for _, player in pairs(game.Players:GetPlayers()) do
	...
	MakePlayerCall(TeleportReceiver.PlayerAdded, player)
end
...
game.Players.PlayerRemoving:Connect(function(player)
	...
	MakePlayerCall(TeleportReceiver.PlayerRemoving, player)
end)
